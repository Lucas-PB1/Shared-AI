...
import { presentProjectHealth } from '../present-health';
      ...
      >
        ...
        <p
          className={cn(
            ...
            view.setupOk ? 'text-sa-primary' : 'text-amber-700',
          )}
        >
          {view.statusLabel}
        </p>
        {view.dirtyCount > 0 ? (
          <p className="mt-1 pl-2 text-xs text-sa-muted">{view.dirtyLabel}</p>
        ) : null}
