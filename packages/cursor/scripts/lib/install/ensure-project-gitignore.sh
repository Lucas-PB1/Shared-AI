...
#
# Source: source "$HOSTDIME_IA_ROOT/packages/cursor/scripts/lib/install/ensure-project-gitignore.sh"
...
scrub_project_gitignore_hostdime() {
  ...
  fragment="$root/packages/cursor/scripts/lib/install/project-gitignore.fragment"
  tmp="$(mktemp)"
