...
install_skills_package() {
  ...
  local install_lib="$cursor_pkg/scripts/lib/install"
  local sync_lib="$cursor_pkg/scripts/lib/sync-inbox"
...
install_code_review_package() {
  ...
  local install_lib="$monorepo_root/packages/cursor/scripts/lib/install"
...
prune_user_symlinks_if_requested() {
  ...
  local cursor_pkg="$monorepo_root/packages/cursor"
  local review_pkg="$monorepo_root/packages/code-review"
  local lib_dir="$cursor_pkg/scripts/lib/install"
  local names=() d f
