...
- `import`/`export` estático; dynamic import para code-splitting
- Default export com moderação; named exports para APIs claras

## Organização

- Barrel files não esconder dependências circulares
- Side effects isolados em entry points

## Resolução

- Extensões e aliases conforme bundler/tsconfig
