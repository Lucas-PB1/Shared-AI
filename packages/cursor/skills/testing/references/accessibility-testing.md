...
- Rodar axe em render principal de páginas críticas
- Corrigir violations reais, não silenciar rules sem motivo

## Manual em testes

- Assert focus após ações
- `toHaveAccessibleName`, `toBeVisible`
