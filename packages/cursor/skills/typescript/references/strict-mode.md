...
- `noUncheckedIndexedAccess` quando arrays/records críticos

## Migração

- Incremental por pasta ou `// @ts-expect-error` temporário documentado
- Nunca desligar strict globalmente por preguiça local
