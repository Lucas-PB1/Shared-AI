...
- `eslint.config.js` exports array de configs
- `files` globs explícitos por ambiente (node vs browser)

## Ignores

- `.eslintignore` ou `ignores` em flat — build output, dist

## Editor

- ESLint extension + format on save alinhado ao Prettier
