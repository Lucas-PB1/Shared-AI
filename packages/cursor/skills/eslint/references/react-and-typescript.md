...
- `eslint-plugin-react-hooks` obrigatório
- `react/prop-types` off em TS

## TypeScript

- Type-aware rules com parserOptions.project
- Evitar `@typescript-eslint/no-explicit-any` off globalmente
