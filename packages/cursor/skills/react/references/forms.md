...
- Value + onChange; single source of truth
- Validar on blur/submit conforme UX

## Libraries

- react-hook-form / formik quando forms grandes — escolher um padrão do projeto

## A11y

- Associar labels; anunciar erros
