...
- Children e slots em vez de props booleanas proliferadas
- Presentational vs container quando testes simplificam

## Props

- Tipar props; defaults documentados
- Spread com cuidado — não vazar props internas ao DOM

## Lists

- `key` estável (id), não index se ordem muda
