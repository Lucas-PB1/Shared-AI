...
- Error boundary em rotas ou widgets críticos
- Fallback UI + log/report

## Async

- Erros em event handlers não sobem ao boundary — tratar localmente
- Suspense para loading; errorElement em routers data APIs
